...
const char* ssid = "YourNetworkName";  // Вводим сюда SSID
const char* password = "YourPassword";  //Вводим пароль
WebServer server(80);
// датчик DHT
uint8_t DHTPin = 4;
// Инициализируем DHT
...
String SendHTML(float TempCstat,float TempFstat,float Humiditystat){
	String ptr = "<!DOCTYPE html> <html>\n";
	ptr +="<head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=no\", http-equiv=\"refresh\" content="2">\n";
